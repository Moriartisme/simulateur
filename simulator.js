...
function type_champ(type_champ,element,evenement){
	...
	var f = document.forms["wf-form-formulaire_"+simulation_hover];
...
function Calcul_capacite(){
	...
	simulation_hover = obj_critere_form.simulation_encours;
	var f = document.forms["wf-form-wf-form-formulaire_"+simulation_hover];
	...
	if(mens_tempo > 0){
		...
		$("#btnresult").click(function(){$("#"+div_parent_simul+" .resultat").show();});
